    ...
    <>
      <form>
        <div className=" min-h-screen text-black flex justify-center items-center ">
          <div className=" h-[50vh] w-xl rounded-2xl  bg-purple-100 m-30">
            <div className="font-bold text-2xl flex justify-center py-6">
              Contact Us
            </div>

            <div className="flex justify-center  my-3 ml-15 items-center bg-white rounded-full p-2 w-full max-w-md hover:transform transition duration-300 hover:scale-105">
              <Image
                height={100}
                width={100}
                src="/person.png"
            ...
            <div className="flex flex-col items-center justify-center mr-2  my-3 ">
              ...
              <button
                type="submit"
                className="bg-purple-500 text-white font-medium py-3 px-8 rounded-full "
              >
                Send Message
              </button>
            </div>
